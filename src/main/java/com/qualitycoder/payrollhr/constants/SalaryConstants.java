package com.qualitycoder.payrollhr.constants;
...
public interface SalaryConstants {
    ...
    public static final double PAYEE_TAX_SALARY_100_125 = 3000.0;
    public static final double PAYEE_TAX_SALARY_125_ABOVE = 4000.0;
}
